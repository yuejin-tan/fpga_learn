...
#define IS_GPIO_REMAP(REMAP) (((REMAP) == GPIO_Remap_TIM0EXTIN  ) || ((REMAP) == GPIO_Remap_TIM1EXTIN )  ||\
  ...
  void GPIO_SetBit(CM3DS_MPS2_GPIO_TypeDef* CM3DS_MPS2_GPIOx, uint16_t GPIO_Pin);
  void GPIO_ResetBit(CM3DS_MPS2_GPIO_TypeDef* CM3DS_MPS2_GPIOx, uint16_t GPIO_Pin);
  ...
  void GPIO_WriteBit(CM3DS_MPS2_GPIO_TypeDef* CM3DS_MPS2_GPIOx, uint16_t GPIO_Pin, BitAction BitVal);
